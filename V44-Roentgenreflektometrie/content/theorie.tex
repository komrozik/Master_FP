...
\section{Theorie}
    ...
    \subsection{Kiessig-Oszillationen}
        ...
        \begin{figure}[ht]
            ...
            \caption{Die Intensitätsverteilung mit den Kiessing Oszillationen.}
    ...
    \subsection{Parrat-Algorithmus}
        ...
        \begin{figure}[ht]
            ...
            \caption{Ein Mehrschichtsystem mit $N+1$ Schichten, an jeder Schicht kann Reflektivität und Transmission rekursiv berechnet werden.}
